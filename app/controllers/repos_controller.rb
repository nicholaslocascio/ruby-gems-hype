class ReposController < ApplicationController
  ...
  # GET /repos.json
  def index
    @repos = Repo.containing_hype_score.order(:hype_score => :desc).limit(400)
  end
  ...
  private
    ...
    def repo_params
      params.require(:repo).permit(:name, :full_name, :stargazers_count, :referenced_count, :references_count)
    end
end
